...
def load_data():
    ...
    df = pd.read_csv('symptoms_dataset_400_with_dosage.csv', encoding='ISO-8859-1')
...
if __name__ == "__main__":
    ...
    symptoms = ['headache', 'fever']  # Replace with input symptoms
    prediction = predict_disease(knn, mlb, symptoms)
